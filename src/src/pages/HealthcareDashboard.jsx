      ...
      <div className="flex-1 overflow-auto">
        ...
        <main className="p-6">
          ...
          <div className="flex space-x-4 mb-8">
            ...
            <button className="bg-teal-600 text-white px-4 py-2 rounded-lg flex items-center space-x-2 hover:bg-teal-700 transition-colors">
              <CreditCard className="w-4 h-4" />
              <span>View Digital Vaccine Card</span>
            </button>
            <button className="bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 hover:bg-gray-800 transition-colors">
